export const DOCUMENTOS: { titulo: string; conteudo: string | null }[] = [
  {
    titulo: "Regimento Interno da Empresa",
    conteudo: `Capítulo I – Disposições Gerais
...
v) trabalhar com o uniforme descaracterizado e/ou descalção, ou ainda, com calçado que não ofereça segurança aos pés;
...
Crachás: serão de uso obrigatório. Após o período de experiência, será fornecido crachá personalizado.
...
Exige-se que os colaboradores observem o que se segue em relação ao uso dos dispositivos, rede, correio eletrônico, telefones, celulares, softwares, hardwares e demais ferramentas de tecnologia da Empresa:
...
Violações ao Código de Ética e Conduta e suas políticas sujeitam os infratores às sanções previstas no Regimento Interno, sem prejuízo das medidas judiciais eventualmente cabíveis.`,
  ...
  {
    titulo: "Política de Combate à Corrupção e Lavagem de Dinheiro",
...
Disponibilizar ao fornecedor o Código de Ética e Conduta do Fornecedor, com Carta de Aceite e Declaração Anticorrupção assinados pelo mesmo.`,
  ...
  {
    titulo: "Política de Gestão de Conflitos de Interesses",
    conteudo: `Aspectos gerais
